...
let TreeEL = $(`[href="${segment}"]`);

TreeEL.closest(".has-treeview").addClass("menu-open").children().addClass('active').find(`a[href='${segment}']`).addClass("active");
TreeEL.toArray().forEach(item => {
