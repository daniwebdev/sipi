...
<div class="wrapper" id="app">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right" id="dropdown-notification">
          <span class="dropdown-item dropdown-header">{{__(':count Notifications', ['count' => 15])}}</span>
          <div class="dropdown-divider"></div>
          {{-- <a href="#" class="dropdown-item">
          ...
          <div class="dropdown-divider"></div>
          <a href="{{route('notification')}}" class="dropdown-item dropdown-footer">{{__('See All Notifications')}}</a>
        </div>
      </li>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right p-0">
          <a href="{{url('lang', ['lang' => 'en']).'?next='.Request::url()}}" class="dropdown-item">
            <i class="flag-icon flag-icon-us mr-2"></i> English
          </a>
          <a href="{{url('lang', ['lang' => 'id']).'?next='.Request::url()}}" class="dropdown-item">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      @include('templates.admin.adminLTE.menu')
    </div>
    <!-- /.sidebar -->
  </aside>
